...
namespace JsonExSerializerTests.Expressions
{
    ...
    public class ReferenceTests
    {
        ...
        public void ResolveObjectObjectTest()
        {
            ...
            Expression actual = ResolveReference(root, "this['child2']");
        ...
        public void ResolveCollectionItemTest()
        {
            ...
            Expression actual = ResolveReference(root, "this[1]");
        ...
        public void ResolveNestedObjectTest()
        {
            ...
            Expression actual = ResolveReference(root, "this['child2']['childB']");
        ...
        public void ResolveNestedCollectionTest()
        {
            ...
            Expression actual = ResolveReference(root, "this[0][1]");
